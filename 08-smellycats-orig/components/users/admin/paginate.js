        ...
        <tbody>
          {shows.docs.map((show) => (
            <tr key={show._id}>
              ...
              <td>{show.venue}</td>
              <td>{show.date}</td>
              <td className='action_btn remove_btn' onClick={() => handleModal(show._id)}>
                Remove
              </td>
              <td className='action_btn edit_btn' onClick={() => goToEdit(show.slug)}>
                Edit
              </td>
            </tr>
          ))}
      ...
      <Pagination>
        {shows.hasPrevPage ? (
          <>
            ...
            <Pagination.Item onClick={() => goToPrevPage(shows.prevPage)}>{shows.prevPage}</Pagination.Item>
          </>
        ) : null}
        <Pagination.Item active>{shows.page}</Pagination.Item>
        {shows.hasNextPage ? (
          <>
            <Pagination.Item onClick={() => goToNextPage(shows.nextPage)}>{shows.nextPage}</Pagination.Item>
