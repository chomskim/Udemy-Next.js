...
import { showValidation, showFields } from 'helpers/validations'

import { TextField, Button, Divider, CircularProgress, Box } from '@mui/material'
...
const CreateShowPage = () => {
  ...
  return (
    <LayoutAdmin title='Create shows'>
      ...
      >
        <UploadHandler picValue={(src) => handlePicValue(src)} ref={clearRef} />
        ...
        {loading ? (
          ...
          <Button className='mt-3 mb-3' variant='contained' color='primary' type='submit'>
            Create show
          </Button>
        )}
      </Box>
